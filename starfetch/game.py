...
class WasmGameStartScene(Scene):
    ...
    def __init__(self, manager):
        ...
        self.title_font = pygame.font.Font(None, size=70)
        self.title_text_surface = self.title_font.render(
            "StarFetch", True, Colors.orange
        )
...
class WasmGameEndScene(Scene):

    __name__ = "WasmGameEndScene"
...
class AsyncStarFetch(object):
    ...
    async def start_game(self):
        ...
        start_scene = WasmGameStartScene(scene_manager)
        end_scene = WasmGameEndScene(scene_manager)
